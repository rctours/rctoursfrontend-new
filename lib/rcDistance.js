...
// ======================================================
// ALLOWED LOCATION TYPES FOR ROAD DISTANCE
// ======================================================
//
// Customer jab city / town / village ka naam deta hai,
// tab restaurant, hotel, shop, college, amenity etc.
// ko destination city nahi maanna hai.
//
// Example:
//
// "Hyderbad"
// Nominatim:
// "Hyderbad Biryani House, Bengaluru"
//
// Ye amenity hai, isliye reject hoga.
//
// ======================================================
...
// ======================================================
// RC LOCATION SPELLING / ALIAS CORRECTIONS
// ======================================================
//
// PURPOSE:
//
// Customer city name ki common spelling mistake kare
// to correct intended location search karna.
//
// IMPORTANT:
//
// Correction sirf ambiguous short input par hogi.
//
// Example:
//
// "Amaravati"
...
// -> change nahi hoga.
//
// Isse genuine Andhra Pradesh location ko galat
// Maharashtra location me force nahi karenge.
//
// ======================================================

function normalizeLocationSearch(address) {
  if (
    !address ||
  ...
  // ====================================================
  // EXPLICIT STATE / REGION PROTECTION
  // ====================================================
  //
  // Customer agar clearly state mention karta hai,
  // to uski location ko kisi doosre state me force
  // nahi karna hai.
  //
  // Example:
  //
  // Amaravati Andhra Pradesh
  // -> Andhra Pradesh hi search hoga.
  //
  // ====================================================

  const mentionsAndhraPradesh =
    /\bandhra\s*pradesh\b|\bandhra\b|\bap\b/i.test(
      normalized
    );
  ...
  if (
    !mentionsAndhraPradesh &&
    (
      normalized === "amaravati" ||
      normalized === "amravti" ||
      normalized === "amaravti" ||
      normalized === "amravati"
    )
  ) {
    return "Amravati, Maharashtra";
  }

  // ====================================================
  // HYDERABAD COMMON TYPOS
  // ====================================================
  ...
  // ====================================================
  // CHANDRAPUR COMMON TYPOS
  // ====================================================

  if (
    normalized === "chandrapoor" ||
    normalized === "chandrapoor" ||
    normalized === "chandrapur"
  ) {
    return "Chandrapur, Maharashtra";
  }
  ...
  // ====================================================
  //
  // Unknown location ko hum guess nahi karenge.
  // Original customer input Nominatim ko diya jayega.
  //
  // ====================================================
