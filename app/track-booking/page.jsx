...
export default function TrackBookingPage() {
  ...
  const handlePayRemaining = async () => {
    ...
    try {
      ...
      const options = {
        ...
        description: `Remaining Payment - ${selectedBooking.bookingId}`,

        prefill: {
          name: selectedBooking.name || "",
          contact: selectedBooking.mobile || "",
  ...
  const handleSearch = async () => {
    if (!bookingId || !mobile) {
      alert(
        "Please enter Booking ID and Mobile Number"
      );
      return;
    }
    ...
    try {
      ...
      if (fetchedBookings.length > 0) {
        localStorage.setItem(
          ...
          JSON.stringify({
            name: fetchedBookings[0].name,

            mobile: fetchedBookings[0].mobile,
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/60 border border-slate-100 p-6 sm:p-10 transition-all">
          ...
          <div className="text-center max-w-lg mx-auto mb-8">
            ...
            <p className="text-slate-500 text-sm sm:text-base leading-relaxed">
              Enter your Booking ID and registered Mobile Number to view and manage your travel booking.
            </p>
              ...
              <div className="mt-8 bg-gradient-to-br from-green-50/80 to-emerald-50/50 border border-green-200/80 shadow-lg rounded-3xl p-5 sm:p-8 backdrop-blur-sm">
                ...
                <div className="space-y-6">
                  ...
                  {paymentSuccess && (
                    ...
                    <div className="bg-green-50 border border-green-300 rounded-2xl p-5 shadow-sm">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <h3 className="font-extrabold text-green-800 text-lg">
                            Payment Completed Successfully
                          </h3>

                          <p className="text-sm text-green-700 mt-1">
                            Your remaining payment has been received successfully. This booking is now fully paid.
                          </p>
                  ...
                  <div className="bg-white/80 border border-gray-100 shadow-sm rounded-2xl p-5">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      ...
                      {Number(
                        ...
                        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-orange-50 text-orange-700 border border-orange-200 font-bold text-sm">
                        ...
                        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-green-50 text-green-700 border border-green-200 font-bold text-sm">
                  ...
                  {Number(
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 disabled:opacity-60 disabled:cursor-not-allowed text-white py-3.5 px-4 rounded-xl font-bold shadow-md hover:shadow-lg transition-all duration-200 active:scale-[0.99] flex items-center justify-center gap-2 cursor-pointer"
                    >
                  ...
                  {Number(
                    ...
                    <div className="bg-green-600 text-white rounded-2xl px-5 py-4 flex items-center gap-3 shadow-lg shadow-green-500/20">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-100 mt-0.5">
                          Your booking payment is fully completed.
                        </p>
                      ...
                      <div className="p-5 bg-gradient-to-br from-amber-50/80 to-yellow-50/50 border border-yellow-200 shadow-sm rounded-2xl">
                        ...
                        <div className="bg-white border border-yellow-100 rounded-2xl p-4 shadow-sm grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                          ...
                          <div className="p-2 border-l border-gray-100">
                            ...
                            <p className="font-bold text-emerald-600 text-lg mt-1 truncate">
                              {loyalty.membership}
                            </p>
          ...
          <div className="mt-8 bg-blue-50/70 border border-blue-200/80 rounded-2xl p-5 sm:p-6">
            ...
            <ul className="space-y-2 text-slate-600 text-xs sm:text-sm">
              ...
              <li>
                Booking details are securely visible to authorized customers.
              </li>

              <li>
                Booking ID and registered mobile number must match.
              </li>

              <li>
                Remaining payment updates automatically after successful payment.
              </li>

              <li>
                Keep your booking information confidential.
              </li>
