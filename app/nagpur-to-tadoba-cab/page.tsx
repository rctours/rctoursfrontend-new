...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "What is the fare from Nagpur to Tadoba?",

      acceptedAnswer: {
        "@type": "Answer",
        text: "Nagpur to Tadoba cab fare starts from ₹2999 depending on the vehicle type and travel plan.",
      },
    },

    {
      "@type": "Question",
      name: "Do you provide round trip taxi service to Tadoba?",

      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, we provide one-way and round-trip taxi service from Nagpur to Tadoba.",
      },
    },

    {
      "@type": "Question",
      name: "Which cars are available?",
...
export default function TadobaPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white pt-24 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-5 text-center">
        ...
        <p className="mt-6 text-gray-300 max-w-3xl mx-auto">
          Book Nagpur to Tadoba taxi service with RC Tours & Travels. Safe
        ...
        <div className="space-y-4 mt-8">
          ...
          <div className="bg-slate-900 p-5 rounded-2xl">
            <h3 className="font-semibold">
              What is the fare from Nagpur to Tadoba?
            </h3>

            <p className="text-gray-300 mt-2">
              Fare starts from ₹2999.
            </p>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-5 mt-16">
        <h2 className="text-3xl font-bold text-center">
          Nagpur to Tadoba Taxi Service
        </h2>

        <div className="mt-8 space-y-6 text-gray-300 leading-8">

          <p>
            RC Tours & Travels provides reliable Nagpur to Tadoba cab booking
            ...
            all areas of Nagpur to Tadoba National Park.
          </p>

          <p>
            Our Nagpur to Tadoba taxi service is available 24×7 with trained
          ...
          <p>
            The distance from Nagpur to Tadoba is approximately 140–150 km,
            depending on the safari gate you choose. We provide taxi service to
            Moharli Gate, Kolara Gate, Navegaon Gate and other entry points of
            Tadoba Tiger Reserve.
          </p>

          <p>
            Customers prefer RC Tours & Travels because of affordable pricing,
      ...
      {/* Popular Safari Gates */}

      <section className="max-w-6xl mx-auto px-5 mt-16">

        <h2 className="text-3xl font-bold text-center">
          Tadoba Safari Gates Covered
        </h2>
      ...
      <section className="max-w-5xl mx-auto px-5 mt-16 text-center">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-10">
          ...
          <h2 className="text-3xl font-bold">
            Book Nagpur to Tadoba Cab Today
          </h2>
